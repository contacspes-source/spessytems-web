...
(function () {
  ...
  var ICONS = {
    ...
    support: 'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z|M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z|M5.6 5.6l2.9 2.9|M15.5 15.5l2.9 2.9|M18.4 5.6l-2.9 2.9|M8.5 15.5l-2.9 2.9',
    message: 'M21 15a2 2 0 0 1-2 2H8l-5 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z',
    chat: 'M8 10h.01M12 10h.01M16 10h.01M21 11.5a7.5 7.5 0 0 1-10.9 6.7L3 20l1.8-4.6A7.5 7.5 0 1 1 21 11.5z',
    ...
    truck: 'M3 6h11v9H3z|M14 9h5l2 3v3h-7z|M7.5 20a1.8 1.8 0 1 0 0-3.6 1.8 1.8 0 0 0 0 3.6z|M18 20a1.8 1.8 0 1 0 0-3.6 1.8 1.8 0 0 0 0 3.6z',
    ...
    cloud: 'M17 18a4 4 0 0 0-1-7.9A5.5 5.5 0 0 0 5.6 11 4 4 0 0 0 6 18z',
    file: 'M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z|M14 3v5h5|M9 13h6M9 17h5',
    dot: 'M12 12h.01'
  };
  function icon(name) {
